...
class ZFLService{
  ...
  async updateCompetitions (leagueId){
    try{
      ...
      if (!Array.isArray(response.data.responseGetCompetitions.competitions.competition)) response.data.responseGetCompetitions.competitions.competition =  [data.responseGetCompetitions.competitions.competition];
