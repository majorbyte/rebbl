...
class CyanideService{
  ...
  async team(params){
    try{
      ...
      const response = await request(`${this._url(`team`)}&${queryString}`);
  ...
  async teams(params){
    try{
      const queryString = CyanideService._serialize(params);
      const response = await request(`${this._url(`teams`)}&${queryString}`);
  ...
  async match(params){
    try{
      const queryString = CyanideService._serialize(params);
      const response = await request(`${this._url(`match`)}&${queryString}`);
  ...
  async contests(params){
    try {
      const queryString = CyanideService._serialize(params);
      const response = await request(`${this._url(`contests`)}&${queryString}`);
