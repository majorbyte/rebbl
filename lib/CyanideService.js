...
class CyanideService{
  ...
  async team(params){
    try{
      ...
      const response =  await axios.get(`${this._url(`team`)}&${queryString}`);
  ...
  async teams(params){
    try{
      const queryString = CyanideService._serialize(params);
      const response = await axios.get(`${this._url(`teams`)}&${queryString}`);
      return response.data;
    } catch(e){
      //todo proper logging
      console.log(e);
  ...
  async match(params){
    try{
      const queryString = CyanideService._serialize(params);
      const response = await axios.get(`${this._url(`match`)}&${queryString}`);
      return response.data;
    } catch(e) {
      //todo proper logging
      console.log(e);
  ...
  async contests(params){
    try {
      const queryString = CyanideService._serialize(params);
      const response =  await axios.get(`${this._url(`contests`)}&${queryString}`);
      return response.data;
    } catch (e){
      //todo proper logging
      console.log(e);
