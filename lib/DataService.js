...
/* MatchDates */    
    ...
    updateMatchDate(param,match,options){
        try{
            this.matchDates.insertOne(param,{set:match},options);
        } catch(err){
            console.error(err);
        }
    }
...
/* Unplayed games */
    ...
    async updateUnplayedGames(param, game, options){
        try{
    ...
    async removeUnplayedGames(filter, options, callback){
        try{
            this.unplayedGames.deleteMany(filter, options, callback);
        }catch(err){
            console.error(err);
        }
    }
...
/* Trophies */
    ...
    async updateTrophy(param, game, options){
        try{
            this.trophies.updateOne(param, game,options);
        }catch(err){
            console.error(err);
        }
    }

    async deleteTrophy(filter, options, callback){
        try{
...
/* Signups */
    ...
    deleteSignup(filter, options, callback){
        try{
            this.signups.deleteOne(filter, options, callback);
        }catch(err){
            console.error(err);
        }
    }
