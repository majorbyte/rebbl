...
class DataService{
    ...
    checkAutomacity(o) { 
        return Object.prototype.hasOwnProperty.call(o,"$set") ? o : {$set:o};
    }
...
/* Schedules */
    ...
    updateSchedule(param,schedule,options){
        try{
            schedule = this.checkAutomacity(schedule);
...
/* Matches */    
    ...
    updateMatch(param,match,options){
        try{
            match = this.checkAutomacity(match);
...
/* Standings */
    ...
    updateStanding(param,standing,options){
        try{
            standing = this.checkAutomacity(standing);
    ...
    async updateStandings(param,standings,options){
        try{
            standings = this.checkAutomacity(standings);
...
/* Teams */
    ...
    updateTeam(param,team,options){
        try{
            team = this.checkAutomacity(team);
...
/* Players */
    ...
    updatePlayer(param,player,options){
        try{
            player = this.checkAutomacity(player);
...
/* Unplayed games */
    ...
    updateUnplayedGame(param, game, options){
        try{
            game = this.checkAutomacity(game);
...
/* Trophies */
    ...
    updateTrophy(param, trophy, options){
        try{
            trophy =this.checkAutomacity(trophy);
...
/* Accounts */
    ...
    updateAccount(param,account,options){
        try{
            account = this.checkAutomacity(account);
...
/* Signups */
    ...
    updateSignup(param, signup, options){
        ...
        try{
            signup = this.checkAutomacity(signup);
...
/* Clans */
    ...
    updateClan(param, clan, options){
        try{
            clan = this.checkAutomacity(clan);
...
/*  Reviews  */
    ...
    updateReview(param, review, options){
        try{
            review = this.checkAutomacity(review);
