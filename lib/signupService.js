...
class SignUpService {
  ...
  async getSignUp(redditName, type, season = "season 24"){
  ...
  async checkTeams(search){
    const data = await dataService.getSignups(search || {season:"season 24",teamId:{$exists:0}});
  ...
  async resign(redditName,type, season = "season 24"){
