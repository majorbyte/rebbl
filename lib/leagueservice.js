      ...
      for(let leagueIndex=0;leagueIndex<leagues.length;leagueIndex++){
        ...
        for(let divisionIndex=0;divisionIndex<divLength;divisionIndex++){
          ...
          if (round){
            ...
            contests = await this.cyanide.contests({platform:"pc", league : league.name, competition: division, round: tempRound-1, status:"played", exact: 1, limit:150});
            ...
            contests = await this.cyanide.contests({platform:"pc", league : league.name, competition: division, round: tempRound,  status:"*", exact: 1});
          } else {
