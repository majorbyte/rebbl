...
class RedraftService{
  ...
  async checkRedraft(teamId, user){
    ...
    team.wrongCompetition =  (response.data.responseGetTeamCompetitions.competitions.competition || false) && response.data.responseGetTeamCompetitions.competitions.competition.id !== this.competitionId;
