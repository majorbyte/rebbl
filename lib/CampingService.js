  ...
  class CampingService{
    ...
    async _processBadges(coaches, match){
      ...
      if (match.teams[0].score >= match.teams[1].score){
        ...
        homeCoach.badges.newSheriffInTown = homeCoach.badges.newSheriffInTown || awayCoach.mainCompetition === "Season 13 - Division 1";
        ...
        awayCoach.badges.newSheriffInTown = awayCoach.badges.newSheriffInTown || homeCoach.mainCompetition === "Season 13 - Division 1";
    ...
    async _newCoach(league, comp, season, coach,team){
      ...
      if (!coachData)
        coachData = await this._getCoachLeagueCompetition(/^rebbrl/i,coach.idcoach,/season 9/i);
