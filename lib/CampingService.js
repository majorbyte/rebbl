  ...
  class CampingService{
    ...
    async _processBadges(coaches, match){
      ...
      if (match.teams[0].score >= match.teams[1].score){
        ...
        homeCoach.badges.Clawgeous = homeCoach.badges.Clawgeous || match.teams[1].roster.filter(x => x.skills.includes("Claw")).length > 0;
        ...
        awayCoach.badges.Clawgeous = awayCoach.badges.Clawgeous || match.teams[0].roster.filter(x => x.skills.includes("Claw")).length > 0;
