...
class Rampup {
  ...
  async getCoachScore() {
    ...
    schedules = await dataService.getSchedules({"competition": {"$regex": new RegExp(/^S19|Season 19|rampup$/,"i")}, "status":"played", "opponents.coach.id": {$in:ids}, "opponents.coach.name":{$ne:"Mystaes"}, "match_uuid":{$gt:"1000a4b5d0"} } );
