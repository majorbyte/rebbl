...
class ConfigurationService {
  constructor() {
    ...
    this.config.findOne({"league":"rabbl"}, function(err,doc){
  ...
  getSeasons () {return this.seasons.concat(this.oneMinuteSeasons).concat(this.linemanSeasons).concat(this.elflySeasons).concat(this.openInvitational).concat(this.greenhorn).concat(this.rabbl)};
